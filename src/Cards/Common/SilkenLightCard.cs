...
public class SilkenLightCard : ModCardTemplate
{
    ...
    {
        var baseValue = DynamicVars["SilkenLight"].BaseValue;
        await PowerCmd.Apply<SilkenLightPower>(choiceContext, Owner.Creature,
